...
- Створити інструкцію лише для адміністратора для налаштування облікового запису програми, який може використовуватися для збереження значень конфігурації програми.  
---

# Стислий виклад  

-   У ланцюгових програмах немає «готових рішень» для створення окремих середовищ, але ви можете досягти чогось подібного до змінних середовища, якщо проявите креативність.  
...
-   Альтернативно, ви можете досягти чогось подібного до змінних середовища, які можна змінювати після розгортання, створюючи облікові записи та інструкції, доступні лише уповноваженим акаунтам, що уповноважені вносити зміни.  
