...
1. Використовувати постачальника індексації, який створить кастомне рішення для індексації вашої програми, спостерігаючи за подіями, що надсилаються до програми Noop, і зберігаючи відповідні дані офчейн.
2. Створити власне псевдо-рішення для індексації, яке зберігатиме дані транзакцій офчейн.
...
Щоб було абсолютно зрозуміло, **це не акаунт, з якого ви зможете читати дані**. Ваша програма створюватиме екземпляр цього типу з вхідних даних інструкції, а не конструюватиме екземпляр цього типу з даних облікового запису, які вона зчитує. Ми обговоримо, як читати дані, у наступному розділі.
...
- `leaf_node` — це масив з 32 байт, що представляє хеш, збережений на ноді листа
...
Далі ми створимо тест `Add Note`. Він має викликати `append_note` з `firstNote`, а потім перевіряти, що хеш ончейн збігається з нашим обчисленим хешем і що лог нотатки збігається з текстом нотатки, яку ми передали в інструкцію.
...
Завантажте свій код на GitHub і [поділіться своїми враженнями від цього уроку](https://form.typeform.com/to/IPH0UGz7#answers-lesson=60f6b072-eaeb-469c-b32e-5fea4b72d1d1)!
